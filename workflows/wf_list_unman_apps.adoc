...
NOTE: Ce workflow répertorie toutes les applications Astra. Vous pouvez consulter la sortie pour déterminer quelles applications ne sont pas gérées en examinant le `managedState` légale.
